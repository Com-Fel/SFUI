...
namespace UI{
    ...
    StyleSheet uniStandartStyle("uniStandartStyle", { { Color(25, 25, 25), Color(100, 100, 100), Color(120, 120, 120) },
                                 { Color(150,150,150) ,Color(150,150,150)  ,Color(150,150,150) },
                                 { Color(255,255,255) ,Color(255,255,255)  ,Color(255,255,255)} }, 2, Vector2f(5, 5), 15, standartFont, { 0,0,0,0 });
